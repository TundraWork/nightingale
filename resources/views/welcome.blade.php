            ...
            <div class="flex items-center">
                <a href="javascript:void(0)"
                   class="group inline-flex items-center gap-2 text-lg font-bold tracking-wide text-white hover:text-white/90">
                    ...
                    <span class="hidden sm:inline">我不是歌神 S1</span>
                </a>
            </div>
            <!-- Left Section -->
    ...
    <main id="page-content" class="flex max-w-full flex-auto flex-col">
        ...
        <div class="container mx-auto space-y-4 p-4 lg:space-y-8 lg:p-8 xl:max-w-6xl">
            ...
            <div class="grid grid-cols-1 gap-4 lg:grid-cols-1 lg:gap-8">
                <div class="rounded-2xl bg-gray-900/50 p-5">
                    <h2 class="text-xl font-bold mb-2">一、赛事宗旨</h2>
                    <p class="mb-4">本次大赛的目的是希望能让更多有潜力的好声音被更多人听到，以及把VRC这平台推广让更多人看见，让观众们有良好的体验，并希望后续可以继续延续这个活动给大家娱乐。</p>

                    <h2 class="text-xl font-bold mb-2">二、参赛人员</h2>
                    <ul class="list-disc list-inside mb-4">
                        <li>6/18 开放报名</li>
                        <li>本次大赛采取开放报名制，不会采取预定邀约，除非有例外发生，将会采取预定邀约，并且我们会审查报名人员，为了保护大赛过程不发生任何冲突以及意外。</li>
                        <li>6/28 报名截止后 当日抽取海选进场顺序</li>
                    </ul>

                    <h2 class="text-xl font-bold mb-2">三、本次賽制内容</h2>
                    <h3 class="text-lg font-bold mb-2">海选</h3>
                    <ul class="list-disc list-inside mb-4">
                        <li>6/30 18:00进场 19:00開始 不公开直播</li>
                        <li>每位选手准备自我介绍+半首歌</li>
                        <li>四位导师逐个听完后进行评分</li>
                        <li>介绍范本 (导师们好 我叫OO 演唱曲目是XXX)</li>
                    ...
                    <h4 class="text-md font-bold mb-2">第一场 戰隊爭奪賽 (第一期 /)</h4>
                    <ul class="list-disc list-inside mb-4">
                    ...
                    <h4 class="text-md font-bold mb-2">第二場 戰隊對抗賽 (第二期 /)</h4>
                    <ul class="list-disc list-inside mb-4">
                        <li>随机抽取各组人员进行 1V1 随机主题单挑赛 (以下为例)</li>
                        <li>会由主办方人员先行抽取各组人员上前来，随机抽取主题 (例: A组人员 抽到了主题:春 )</li>
                        <li>得知主题后选择对方战对其中一名人员来和自己进行单挑</li>
                        <li>若对方拒绝和你单挑，则由主办方随机抽取对方一名选手 和该选手进行单挑，对方无法拒绝。</li>
                        <li>以此类推，抽完5种主题后由导师们和学员们进行讨论及训练 训练时间 :</li>
                        <li>比赛当天会有主持人公布进场顺序，由哪方先开始。</li>
                        <li>当天会以直播以及现场观众的投票计分</li>
                        <li>由票数较多的队伍获胜，成绩则会在五组比试结束后公布</li>
                        <li>总计获胜多的队伍胜利，输的则全队淘汰</li>
                    </ul>

                    <h4 class="text-md font-bold mb-2">第三场 幸存者生死战 (第二期 /)</h4>
                    <ul class="list-disc list-inside mb-4">
                        <li>每位选手准备一首决赛歌曲主题由自己决定，每位选手演唱结束后会由5位评审进行评分直到5位选手演唱结束。</li>
                        <li>结束后会由主持人公布名次</li>
                    </ul>

                    <h2 class="text-xl font-bold mb-2">四、此次大赛需准备</h2>
                    <p class="mb-4">每位选手需要在比赛之前把演唱曲目还有VRC准备好交给主办方</p>

                    <h2 class="text-xl font-bold mb-2">五、責任相關</h2>
